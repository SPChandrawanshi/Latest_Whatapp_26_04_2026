  ...
  return (
    <div className="space-y-8">
      <div className="flex justify-between items-start">
        ...
        <button className="px-6 py-3 bg-[#0a3d62] text-white rounded-2xl shadow-xl font-black uppercase text-xs tracking-widest flex items-center gap-2">
        ...
        {[
          ...
          <div key={i} className="bg-white p-6 rounded-[2rem] shadow-premium border border-transparent hover:border-[#0a3d62] transition-all group relative overflow-hidden">
             ...
             <div className="flex items-center justify-between mt-6 pt-6 border-t border-slate-50">
                ...
                <button className="p-2 bg-slate-50 rounded-xl hover:bg-[#0a3d62] hover:text-white transition-all">
      ...
      <div className="bg-white p-8 rounded-[2.5rem] shadow-premium border border-dashed border-slate-200 flex flex-col items-center justify-center text-center">
